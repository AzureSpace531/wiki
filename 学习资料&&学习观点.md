...
[Gazebo : Tutorial : Which combination of ROS/Gazebo versions to use](https://classic.gazebosim.org/tutorials?tut=ros_wrapper_versions&cat=connect_ros)

```
# 参考以上网址在终端的下载命令
sudo install ros-galactic-gazebo-ros-pkgs
sudo install ros-galactic-gazebo-ros-control
```

```
# 使用以下命令打开gazebo软件,你也可以输入gazebo之后使用 Tab键补全
gazebo-11.10.2 
```
...
https://fishros.com/d2lros2humble/#/
机器人这一块
